...
const formSchema = z.object({
  name: z
    ...
    .max(50, { message: "ชื่อผู้ออกต้องไม่มากกว่า 50 ตัวอักษร" }),
  address: z
    .string()
    .min(1, { message: "ที่อยู่ผู้ออกต้องมีมากกว่า 1 ตัวอักษร" })
    .max(200, { message: "ที่อยู่ผู้ออกต้องไม่มากกว่า 200 ตัวอักษร" }),
  taxId: z
    .string()
    .min(1, { message: "เลขประจำตัวผู้เสียภาษีต้องมีมากกว่า 1 ตัวอักษร" })
    .max(50, { message: "เลขประจำตัวผู้เสียภาษีต้องไม่มากกว่า 50 ตัวอักษร" }),
  phone: z
    .string()
    .min(1, { message: "เบอร์โทรศัพท์ผู้ออกต้องมีมากกว่า 1 ตัวอักษร" })
    .max(50, { message: "เบอร์โทรศัพท์ผู้ออกต้องไม่มากกว่า 50 ตัวอักษร" }),
});
